...
/* harmony import */ var _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-BJaRj3Rj.js */ 308);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.o)(document);
  ...
  onBackdropClick(ev) {
    ...
    if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
      ...
      if (shouldClose) {
        ev.preventDefault();
        ev.stopPropagation();
        this.close(undefined, _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.B);
      }
    }
  }
  onKeydown(ev) {
  ...
  trapKeyboardFocus(ev, doc) {
    ...
    if (this.el.contains(target)) {
       ...
       * here to avoid that.
       */
      (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.n)(el);
      /**
      ...
      if (this.lastFocus === doc.activeElement) {
        (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.q)(el);
      }
    }
  }
  _setOpen(_x) {
    var _this4 = this;
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true, role) {
  ...
  onWillStart() {
    this.beforeAnimation(!this._isOpen, _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.G);
  ...
  onEnd(detail) {
    ...
    this.animation.easing('cubic-bezier(0.4, 0.0, 0.6, 1)').onFinish(() => this.afterAnimation(shouldOpen, _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.G), {
  ...
  updateState() {
    ...
    if (!isActive) {
       ...
       */
      this.afterAnimation(false, _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_3__.G);
    }
  }
  render() {
    const {
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
...
const MenuButton = class {
  constructor(hostRef) {
     ...
     */
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-menu_3_entry_js.277d13cd943ee759.js.map
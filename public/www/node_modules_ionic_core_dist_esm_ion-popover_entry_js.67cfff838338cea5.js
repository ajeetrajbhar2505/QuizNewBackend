...
/* harmony import */ var _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-BJaRj3Rj.js */ 308);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  dismiss(_x4, _x5) {
    var _this3 = this;
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      ...
      const shouldDismiss = yield (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        ...
        [_overlays_BJaRj3Rj_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-popover_entry_js.67cfff838338cea5.js.map